	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				// A-Z, a-z -> State 1
				// this deviates from FoundationCode in limiting the first character to alphabetic and not alphanumeric characters
			...
			case 1: 
				...
				// . or - or _ -> State 2
				// This deviates from FoundationCode in allowing minus signs and underscores (stream spoiled little brat)
				// between subsequent alphabetical characters.
		...
		case 0:
			...
			// Accommodating the deviations from FoundationCode, this error message limits the allowed range of initial characters to the alphabet.
		...
		case 1:
			...
			if (userNameSize < 4) {
				...
				userNameRecognizerErrorMessage += 
					"A UserName character may only contain the characters A-Z, a-z, 0-9, or minus signs, underscores (my hero), or periods under special circumstances.\n";
				return userNameRecognizerErrorMessage;
			}
			else {
					// UserName is valid
		...
		case 2:
			...
			// Accommodating the above deviations from FoundationCode, this displays to the user that the allowed range of interstitial characters has expanded.
			userNameRecognizerErrorMessage +=
