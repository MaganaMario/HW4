...
public class PasswordEvaluator {
	...
	public static String evaluatePassword(String input) {
		...
		foundInvalidChar = false;			// Reset the Boolean flag
		...
		while (running) {
			...
			// valid transitions
			// This deviates from FoundationCode by adding a Boolean flag for finding an invalid character.
		...
		passwordIndexofError = currentCharNdx;
		return "Password missing: " + errMessage + "conditions were not satisfied";
